...
class Infiltration < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    design_airflow_temp = 8.57 + 19.84 + 19.80 + 19.78 + 21.87
    supply_flow.setDefaultValue(design_airflow_temp)
